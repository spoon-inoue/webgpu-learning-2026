...
// color, matrix, [matrix padding]
const uniformBufferSize = (4 + 9 + 3) * Float32Array.BYTES_PER_ELEMENT
...
function render() {
  ...
  const projectionMaterix = mat3.projection(renderTarget.size.width, renderTarget.size.height)
  ...
  matrix = mat3.multiply(matrix, projectionMaterix)
