...
const settings = {
  translation: [100, 20] as [number, number],
  rotation: 15,
  scale: [0.8, 0.8] as [number, number],
}
...
function render() {
  ...
  for (const { uniformBuffer, uniformValues, resolutionValue, matrixValue, bindGroup } of objectInfos) {
