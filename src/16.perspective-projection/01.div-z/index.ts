...
const uniformBufferSize = (16 + 1 + 3) * Float32Array.BYTES_PER_ELEMENT
...
const settings = {
  translation: [renderTarget.size.width / 2 - 200, renderTarget.size.height / 2 - 75, -1000] as N3,
...
function render() {
  ...
  mat4.ortho(0, renderTarget.size.width, renderTarget.size.height, 0, 1200, -1000, matrixValue)
