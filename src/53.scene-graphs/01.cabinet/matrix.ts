import type { Matrix, Vec3 } from '@/modules/common/types'
...
export const mat4 = {
  ...
  translation([tx, ty, tz]: Vec3, dst?: Matrix) {
    dst = dst || new Float32Array(16)
    // prettier-ignore
    return setMatrix(dst, [
       1,  0,  0,  0,
  ...
  scaling([sx, sy, sz]: Vec3, dst?: Matrix) {
    dst = dst || new Float32Array(16)
    // prettier-ignore
    return setMatrix(dst, [
      sx,   0,   0,  0,
  ...
  translate(m: Matrix, translation: Vec3, dst?: Matrix) {
  ...
  scale(m: Matrix, scale: Vec3, dst?: Matrix) {
