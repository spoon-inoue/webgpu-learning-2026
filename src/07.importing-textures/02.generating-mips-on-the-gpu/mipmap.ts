...
function copySourceToTexture(device: GPUDevice, texture: GPUTexture, source: ImageBitmap, { flipY }: Options) {
  // prettier-ignore
...
function createTextureFromSource(device: GPUDevice, source: ImageBitmap, options: Options) {
